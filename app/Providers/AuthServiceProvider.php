...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: Manajemen buku
        Gate::define('manajemen_buku_access', function ($user) {
        ...
        // Auth gates for: Peminjaman
        Gate::define('peminjaman_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('peminjaman_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('peminjaman_edit', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('peminjaman_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('peminjaman_delete', function ($user) {
            return in_array($user->role_id, [1]);
        });
