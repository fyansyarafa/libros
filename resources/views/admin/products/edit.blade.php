...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('tahun_terbit', trans('quickadmin.products.fields.tahun-terbit').'', ['class' => 'control-label']) !!}
                    {!! Form::number('tahun_terbit', old('tahun_terbit'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('penerbit', trans('quickadmin.products.fields.penerbit').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('penerbit', old('penerbit'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('lokasi_buku', trans('quickadmin.products.fields.lokasi-buku').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('lokasi_buku', old('lokasi_buku'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('lokasi_buku'))
                        <p class="help-block">
                            {{ $errors->first('lokasi_buku') }}
                        </p>
                    @endif
                </div>
            </div>
