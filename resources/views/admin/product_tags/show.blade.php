...
<li role="presentation" class="active"><a href="#products" aria-controls="products" role="tab" data-toggle="tab">Buku</a></li>
</ul>
    ...
    <thead>
        <tr>
            <th>@lang('quickadmin.products.fields.name')</th>
                        <th>@lang('quickadmin.products.fields.tahun-terbit')</th>
                        <th>@lang('quickadmin.products.fields.penerbit')</th>
                        <th>@lang('quickadmin.products.fields.category')</th>
                        <th>@lang('quickadmin.products.fields.tag')</th>
                        <th>@lang('quickadmin.products.fields.lokasi-buku')</th>
            ...
            @foreach ($products as $product)
                <tr data-entry-id="{{ $product->id }}">
                    <td field-key='name'>{{ $product->name }}</td>
                                <td field-key='tahun_terbit'>{{ $product->tahun_terbit }}</td>
                                <td field-key='penerbit'>{{ $product->penerbit }}</td>
                                ...
                                <td field-key='lokasi_buku'>{{ $product->lokasi_buku }}</td>
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.product_tags.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
